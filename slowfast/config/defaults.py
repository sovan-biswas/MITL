...
# Is the code is for weak supervision or full supervision
_C.MODEL.IS_FULL = True

# If Uncertainity aware
_C.MODEL.UNCERTAINITY = False

# If contrastive learning used
...
# Clip duration for weakly supervised
_C.AVA.CLIP_DURATION = 1

# AVA Peturbations
_C.AVA.PERTURBATION = 0
